...
// this is a direct copy of the following, which includes some very nice features written by very nice people
// https://github.com/containous/traefik/blob/master/pkg/udp/conn.go
